...
function createCash() {
  if (World.frameCount % 100 == 0) {
    var cash = createSprite(width-320, 40, 10, 10);
    cash.x = Math.round(random(50, 700))
...
function createDiamonds() {
  if (World.frameCount % 120 == 0) {
    var diamonds = createSprite(width-320, 40, 10, 10);
   diamonds.x =  Math.round(random(50, 700))
...
function createJwellery() {
  if (World.frameCount % 180 == 0) {
    var jwellery = createSprite(width-320, 40, 10, 10);
   jwellery.x =  Math.round(random(50, 700))
...
function createSword() {
  if (World.frameCount % 300 == 0) {
    var sword = createSprite(width-320, 40, 10, 10);
    Math.round(random(30, 700))
